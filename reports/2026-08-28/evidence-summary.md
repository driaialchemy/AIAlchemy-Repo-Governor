...
**Report date:** 2026-08-28T06:22:22+00:00
...
- **Audit file:** `audit/multi_repo/2026-08-28/repo_Agent-Workflow-Review_20260828T062223Z.json`
- **Remaining issues:**
...
- **Remediation status:** not_requested
- **Verification status:** scan_only_no_verification_loop
- **Audit file:** `audit/multi_repo/2026-08-28/repo_agentstack_20260828T062223Z.json`
- **Remaining issues:**
  - Risk level is MEDIUM, expected LOW.
  - Dependency manifests present: requirements.txt
  - Test suite present — actively developed project.
...
- **Remediation status:** not_requested
- **Verification status:** scan_only_no_verification_loop
- **Audit file:** `audit/multi_repo/2026-08-28/repo_ai-agent-governance_20260828T062224Z.json`
- **Remaining issues:**
...
- **Remediation status:** not_requested
- **Verification status:** scan_only_no_verification_loop
- **Audit file:** `audit/multi_repo/2026-08-28/repo_ai-agent-research-emailer_20260828T062225Z.json`
- **Remaining issues:**
  - Risk level is MEDIUM, expected LOW.
  - Dependency manifests present: requirements.txt
...
- **Remediation status:** not_requested
- **Verification status:** scan_only_no_verification_loop
- **Audit file:** `audit/multi_repo/2026-08-28/repo_ai-alchemy-prompt-evaluator_20260828T062225Z.json`
- **Remaining issues:**
...
- **Remediation status:** not_requested
- **Verification status:** scan_only_no_verification_loop
- **Audit file:** `audit/multi_repo/2026-08-28/repo_AIAlchemy-Repo-Governor_20260828T062225Z.json`
- **Remaining issues:**
...
- **Remediation status:** not_requested
- **Verification status:** scan_only_no_verification_loop
- **Audit file:** `audit/multi_repo/2026-08-28/repo_contract-risk-review-pipeline_20260828T062226Z.json`
- **Remaining issues:**
  - Risk level is MEDIUM, expected LOW.
  - Dependency manifests present: requirements.txt
  - HTTP networking libraries in use: requests
...
- **Remediation status:** not_requested
- **Verification status:** scan_only_no_verification_loop
- **Audit file:** `audit/multi_repo/2026-08-28/repo_contractriskreviewpipeline_20260828T062226Z.json`
- **Remaining issues:**
...
- **Remediation status:** not_requested
- **Verification status:** scan_only_no_verification_loop
- **Audit file:** `audit/multi_repo/2026-08-28/repo_Device-Lifecycle-Intelligence-Platform-DLIP-_20260828T062247Z.json`
- **Remaining issues:**
...
- **Remediation status:** not_requested
- **Verification status:** scan_only_no_verification_loop
- **Audit file:** `audit/multi_repo/2026-08-28/repo_expenseverificationpipeline_20260828T062248Z.json`
...
- **Remediation status:** not_requested
- **Verification status:** scan_only_no_verification_loop
- **Audit file:** `audit/multi_repo/2026-08-28/repo_fishhatchery_20260828T062248Z.json`
...
- **Remediation status:** not_requested
- **Verification status:** scan_only_no_verification_loop
- **Audit file:** `audit/multi_repo/2026-08-28/repo_governance-logger_20260828T062248Z.json`
- **Remaining issues:**
  - Risk level is MEDIUM, expected LOW.
...
- **Remediation status:** not_requested
- **Verification status:** scan_only_no_verification_loop
- **Audit file:** `audit/multi_repo/2026-08-28/repo_jobseeker_20260828T062249Z.json`
- **Recommended next action:** No action required — repository is agent-ready.
...
- **Remediation status:** not_requested
- **Verification status:** scan_only_no_verification_loop
- **Audit file:** `audit/multi_repo/2026-08-28/repo_mavenfuzzyfactory_20260828T062249Z.json`
- **Remaining issues:**
  - Risk level is MEDIUM, expected LOW.
  - Dependency manifests present: pyproject.toml
...
- **Remediation status:** not_requested
- **Verification status:** scan_only_no_verification_loop
- **Audit file:** `audit/multi_repo/2026-08-28/repo_mslw111_20260828T062250Z.json`
- **Recommended next action:** No action required — repository is agent-ready.
...
- **Remediation status:** not_requested
- **Verification status:** scan_only_no_verification_loop
- **Audit file:** `audit/multi_repo/2026-08-28/repo_skillsartifactsbuild_20260828T062250Z.json`
- **Recommended next action:** No action required — repository is agent-ready.
...
- **Remediation status:** not_requested
- **Verification status:** scan_only_no_verification_loop
- **Audit file:** `audit/multi_repo/2026-08-28/repo_testingsoftwareengineering_20260828T062250Z.json`
- **Remaining issues:**
  - Risk level is MEDIUM, expected LOW.
  - Dependency manifests present: requirements.txt
  - Test suite present — actively developed project.
...
- **Remediation status:** not_requested
- **Verification status:** scan_only_no_verification_loop
- **Audit file:** `audit/multi_repo/2026-08-28/repo_workeragentcowork_20260828T062251Z.json`
- **Remaining issues:**
  - Multiple AI provider integrations (anthropic, openai) — elevated orchestration complexity.
  - Credential pattern indicators in code: api_key
  - External database terms detected (postgres) — potential data compliance risk.
...
- **Expected evidence:** Updated audit file with PASS status: audit/multi_repo/2026-08-28/repo_Agent-Workflow-Review_20260828T062223Z.json
...
- **Corrective action:** Review audit evidence and run prompt_only or goal_loop when ready to remediate.
- **Verification action:** Re-run `repo-governor weekly-evidence --mode scan_only` and confirm agent-ready PASS for this repository.
- **Expected evidence:** Updated audit file with PASS status: audit/multi_repo/2026-08-28/repo_agentstack_20260828T062223Z.json
- **Recommended mode:** prompt_only
- **Human review required:** No
- **Note:** Weekly scan_only mode reports findings only — target repos are not modified automatically.
...
- **Verification action:** Re-run `repo-governor weekly-evidence --mode scan_only` and confirm agent-ready PASS for this repository.
- **Expected evidence:** Updated audit file with PASS status: audit/multi_repo/2026-08-28/repo_ai-agent-governance_20260828T062224Z.json
- **Recommended mode:** prompt_only
...
- **Corrective action:** Review audit evidence and run prompt_only or goal_loop when ready to remediate.
- **Verification action:** Re-run `repo-governor weekly-evidence --mode scan_only` and confirm agent-ready PASS for this repository.
- **Expected evidence:** Updated audit file with PASS status: audit/multi_repo/2026-08-28/repo_ai-agent-research-emailer_20260828T062225Z.json
- **Recommended mode:** prompt_only
- **Human review required:** No
- **Note:** Weekly scan_only mode reports findings only — target repos are not modified automatically.
...
- **Corrective action:** Resolve HIGH-risk blocking issues before allowing any agent access.
- **Verification action:** Re-run `repo-governor weekly-evidence --mode scan_only` and confirm agent-ready PASS for this repository.
- **Expected evidence:** Updated audit file with PASS status: audit/multi_repo/2026-08-28/repo_ai-alchemy-prompt-evaluator_20260828T062225Z.json
- **Recommended mode:** prompt_only
- **Human review required:** Yes
- **Note:** Weekly scan_only mode reports findings only — target repos are not modified automatically.
...
- **Corrective action:** Resolve HIGH-risk blocking issues before allowing any agent access.
- **Verification action:** Re-run `repo-governor weekly-evidence --mode scan_only` and confirm agent-ready PASS for this repository.
- **Expected evidence:** Updated audit file with PASS status: audit/multi_repo/2026-08-28/repo_AIAlchemy-Repo-Governor_20260828T062225Z.json
- **Recommended mode:** prompt_only
- **Human review required:** Yes
- **Note:** Weekly scan_only mode reports findings only — target repos are not modified automatically.
...
- **Corrective action:** Review audit evidence and run prompt_only or goal_loop when ready to remediate.
- **Verification action:** Re-run `repo-governor weekly-evidence --mode scan_only` and confirm agent-ready PASS for this repository.
- **Expected evidence:** Updated audit file with PASS status: audit/multi_repo/2026-08-28/repo_contract-risk-review-pipeline_20260828T062226Z.json
- **Recommended mode:** prompt_only
- **Human review required:** No
- **Note:** Weekly scan_only mode reports findings only — target repos are not modified automatically.
...
- **Corrective action:** Resolve HIGH-risk blocking issues before allowing any agent access.
- **Verification action:** Re-run `repo-governor weekly-evidence --mode scan_only` and confirm agent-ready PASS for this repository.
- **Expected evidence:** Updated audit file with PASS status: audit/multi_repo/2026-08-28/repo_contractriskreviewpipeline_20260828T062226Z.json
- **Recommended mode:** prompt_only
- **Human review required:** Yes
- **Note:** Weekly scan_only mode reports findings only — target repos are not modified automatically.
...
- **Corrective action:** Resolve HIGH-risk blocking issues before allowing any agent access.
- **Verification action:** Re-run `repo-governor weekly-evidence --mode scan_only` and confirm agent-ready PASS for this repository.
- **Expected evidence:** Updated audit file with PASS status: audit/multi_repo/2026-08-28/repo_Device-Lifecycle-Intelligence-Platform-DLIP-_20260828T062247Z.json
- **Recommended mode:** prompt_only
- **Human review required:** Yes
- **Note:** Weekly scan_only mode reports findings only — target repos are not modified automatically.
...
- **Corrective action:** Resolve HIGH-risk blocking issues before allowing any agent access.
- **Verification action:** Re-run `repo-governor weekly-evidence --mode scan_only` and confirm agent-ready PASS for this repository.
- **Expected evidence:** Updated audit file with PASS status: audit/multi_repo/2026-08-28/repo_expenseverificationpipeline_20260828T062248Z.json
- **Recommended mode:** prompt_only
- **Human review required:** Yes
- **Note:** Weekly scan_only mode reports findings only — target repos are not modified automatically.
...
- **Corrective action:** Review audit evidence and run prompt_only or goal_loop when ready to remediate.
- **Verification action:** Re-run `repo-governor weekly-evidence --mode scan_only` and confirm agent-ready PASS for this repository.
- **Expected evidence:** Updated audit file with PASS status: audit/multi_repo/2026-08-28/repo_governance-logger_20260828T062248Z.json
- **Recommended mode:** prompt_only
- **Human review required:** No
- **Note:** Weekly scan_only mode reports findings only — target repos are not modified automatically.
...
- **Corrective action:** Review audit evidence and run prompt_only or goal_loop when ready to remediate.
- **Verification action:** Re-run `repo-governor weekly-evidence --mode scan_only` and confirm agent-ready PASS for this repository.
- **Expected evidence:** Updated audit file with PASS status: audit/multi_repo/2026-08-28/repo_mavenfuzzyfactory_20260828T062249Z.json
- **Recommended mode:** prompt_only
- **Human review required:** No
- **Note:** Weekly scan_only mode reports findings only — target repos are not modified automatically.
...
- **Corrective action:** Review audit evidence and run prompt_only or goal_loop when ready to remediate.
- **Verification action:** Re-run `repo-governor weekly-evidence --mode scan_only` and confirm agent-ready PASS for this repository.
- **Expected evidence:** Updated audit file with PASS status: audit/multi_repo/2026-08-28/repo_testingsoftwareengineering_20260828T062250Z.json
- **Recommended mode:** prompt_only
- **Human review required:** No
- **Note:** Weekly scan_only mode reports findings only — target repos are not modified automatically.
...
- **Corrective action:** Resolve HIGH-risk blocking issues before allowing any agent access.
- **Verification action:** Re-run `repo-governor weekly-evidence --mode scan_only` and confirm agent-ready PASS for this repository.
- **Expected evidence:** Updated audit file with PASS status: audit/multi_repo/2026-08-28/repo_workeragentcowork_20260828T062251Z.json
- **Recommended mode:** prompt_only
- **Human review required:** Yes
- **Note:** Weekly scan_only mode reports findings only — target repos are not modified automatically.
